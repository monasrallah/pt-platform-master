...
import 'package:pt_platform/presentation/trainee/coach/challenge/getx/challenge_controller.dart';
...
class ChallengeVideoPage extends GetView<ChallengeController> {
  const ChallengeVideoPage({Key? key}) : super(key: key);

  // final ChallengeVideoEntity challengeVideo;
