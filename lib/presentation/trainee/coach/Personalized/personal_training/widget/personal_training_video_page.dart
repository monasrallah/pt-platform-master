...
class PersonalTrainingVideoPage extends GetView<PersonalTrainingController> {
  const PersonalTrainingVideoPage({Key? key}) : super(key: key);
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ImageCardHorizon(
                        ...
                        des:
                            "${AppStrings.weight.tr}: ${controller.videos[index].weight}, ${AppStrings.sets.tr}:${controller.videos[index].sets}, ${AppStrings.repetition.tr}: ${controller.videos[index].repetition} ",
                        onTap: () {
