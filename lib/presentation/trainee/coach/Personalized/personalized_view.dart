...
import 'getx/personalized_controller.dart';

class PersonalizedView extends GetView<PersonalizedController> {
  const PersonalizedView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: appBackBar(title: 'Personalized'),
      body: buildBody(),
    );
  }
