...
class LiveChatCoachView extends GetView<LiveChatCoachController> {
  const LiveChatCoachView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBackBar(title: AppStrings.liveChat.tr),
      body: buildBody(),
    ...
    return Padding(
      ...
      child: StreamBuilder<Object>(
          stream: controller.chatService.getMessages(
              int.parse(controller.coachId.value),
              ...
              child: CustomTextField(
                ...
                suffixIcon: TextButton(
                  ...
                  child: Text(
                    AppStrings.send.tr,
                    style:
                        Get.textTheme.headlineMedium!.copyWith(fontSize: 17.sp),
                  ),
                ),
              ),
            ),
