...
class ExerciseUserHistoryCoachPage extends GetView<UserHistoryCoachController> {
  const ExerciseUserHistoryCoachPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBackBar(title: 'Exercise History'),
      body: buildBody(),
    );
  }
