...
class WorkoutsCoachController extends GetxController {
  ...
  getSectionWorkOut() async {
    ...
    (await baseCoachAppRepository
            .getSectionWorkOut(Get.find<CoachHomeController>().coachId.value))
        .fold(
  ...
  getWorkOut() async {
    isLoading = true;
    (await baseCoachAppRepository.getWorkOut(
  ...
  getWorkOutVideo(exerciseId) async {
    isLoading = true;
    (await baseCoachAppRepository.getWorkOutVideo(
