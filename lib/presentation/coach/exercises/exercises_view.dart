...
import 'package:pt_platform/presentation/coach/exercises/getx/exercises_controller.dart';
...
import 'widget/exercises_coach_details_page.dart';
import 'widget/exercises_list_widget.dart';

class ExercisesCoachView extends GetView<ExercisesCoachController> {
  const ExercisesCoachView({Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Obx(
          () => controller.isLoading
              ...
              : controller.sections.isEmpty ||
                      controller.sections[controller.sectionSelect.value]
                          .category.isEmpty
                  ? SizedBox(
                      height: 0.7.sh,
                      width: 1.sw,
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ExercisesCoachListWidget(
                          title: controller
                              .sections[controller.sectionSelect.value]
                              .category[index]
                              .title,
